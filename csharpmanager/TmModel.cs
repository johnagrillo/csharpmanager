...
{
List<TmModel> get(OdbcConnection connection)
{
  var collection = new List<TmModel>();
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  while (reader.Read())
  {
      ...
      collection.Add( new TmModel(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16));
    }
  }
  return collection;
}
  ...
  // Constructor
  TmModel(long wk_ptr, short wk_line, string wk_type, short circuit_line, short circuit_tot, short circuit_reps, long set_reps, long set_dist, long set_interval, string set_desc, string set_note, short set_energyno, string set_type, string set_categoryabbr, long tot_yards, long set_starttime, long set_finishtime )
  {
    Wk_ptr = wk_ptr;
    Wk_line = wk_line;
    Wk_type = wk_type;
