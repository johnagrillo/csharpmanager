...
public class MmAltscoring 
{
List<MmAltscoring> get(OdbcConnection connection)
{
  var collection = new List<MmAltscoring>();
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  while (reader.Read())
  {
      ...
      collection.Add( new MmAltscoring(arg0, arg1, arg2, arg3, arg4));
    }
  }
  return collection;
}
  ...
  // Constructor
  MmAltscoring(short score_divno, string score_sex, short score_place, float ind_score, float rel_score )
  {
