...
public class TmWorkcategory 
{
List<TmWorkcategory> get(OdbcConnection connection)
{
  var collection = new List<TmWorkcategory>();
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  while (reader.Read())
  {
      ...
      collection.Add( new TmWorkcategory(arg0, arg1));
    }
  }
  return collection;
}
  ...
  // Constructor
  TmWorkcategory(string stroke_abbr, string stroke_name )
  {
