...
public class TmWkparam 
{
List<TmWkparam> get(OdbcConnection connection)
{
  var collection = new List<TmWkparam>();
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  while (reader.Read())
  {
      ...
      collection.Add( new TmWkparam(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10));
    }
  }
  return collection;
}
  ...
  // Constructor
  TmWkparam(long wk_ptr, long wk_num, DateTime wk_date, long start_time, short rest_period, string group_abbr, string subgroup_abbr, string course_yls, long tot_yards, long tot_stress, bool ck_selected )
  {
    Wk_ptr = wk_ptr;
    Wk_num = wk_num;
    Wk_date = wk_date;
