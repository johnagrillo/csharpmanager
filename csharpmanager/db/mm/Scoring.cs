...
public class Scoring(short? score_divno, string score_sex, short? score_place, float? ind_score, float? rel_score )
{
static public List<Scoring> Get(OdbcConnection connection)
{
  var collection = new List<Scoring>();
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  ...
  var arg4 = reader.IsDBNull(4) ? (float?)null :reader.GetFloat(4); /* rel_score nullable true*/
      collection.Add( new Scoring(arg0, arg1, arg2, arg3, arg4));
    }
  }
  return collection;
}
