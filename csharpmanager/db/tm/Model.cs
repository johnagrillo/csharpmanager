...
public class Model(long? wk_ptr, short? wk_line, string wk_type, short? circuit_line, short? circuit_tot, short? circuit_reps, long? set_reps, long? set_dist, long? set_interval, string set_desc, string set_note, short? set_energyno, string set_type, string set_categoryabbr, long? tot_yards, long? set_starttime, long? set_finishtime )
{
static public List<Model> Get(OdbcConnection connection)
{
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  ...
  var arg16 = reader.IsDBNull(16) ? (long?)null :reader.GetInt32(16); /* set_finishtime nullable true*/
      collection.Add( new Model(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16));
    }
  }
  return collection;
}
