...
public class Modelparam(long? wk_ptr, long? wk_num, DateTime? wk_date, long? start_time, short? rest_period, string group_abbr, string subgroup_abbr, string course_yls, long? tot_yards, long? tot_stress, bool ck_selected )
{
static public List<Modelparam> Get(OdbcConnection connection)
{
  var collection = new List<Modelparam>();
  ...
  using (OdbcDataReader reader = command.ExecuteReader())
{
  ...
  var arg10 = reader.GetBoolean(10); /* ck_selected nullable false*/
      collection.Add( new Modelparam(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10));
    }
  }
  return collection;
}
